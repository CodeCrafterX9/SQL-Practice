...
SELECT  
(
SELECT STRING_AGG(topping, ',' ORDER BY topping)
FROM (
VALUES
(pt1.topping_name),
(pt2.topping_name),
...
inner join pizza_toppings pt2 on pt1.topping_name <> pt2.topping_name
inner join pizza_toppings pt3 on pt1.topping_name <> pt3.topping_name 
and pt3.topping_name <> pt2.topping_name
)

select combo as pizza,min(total_cost) total_cost from cte_1
group by 1
order by 2 desc, 1 
