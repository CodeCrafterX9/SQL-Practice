...
/**
Approach : Basically i have firstly grouped the entries on date basis and since any type of activity gets the user considered as active, I have used count()
to count the distinct users for each date
Then i have used the date filter to filter out 30 days as described in the question
**/
