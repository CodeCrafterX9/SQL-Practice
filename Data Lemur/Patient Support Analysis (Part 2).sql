/** UNITED HEALTH INTERVIEW QUESTION
...
**/
select round(sum(uc)*100.0/count(*),1) as uncategorised_call_pct
from (
SELECT *,
case when (call_category is null or call_category='n/a') then 1 else 0 end as uc
FROM callers
)t 
